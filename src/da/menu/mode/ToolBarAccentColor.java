...
public class ToolBarAccentColor extends JPanel {
    ...
    try {
        ...
        FlatLaf.setup(lafClass.getDeclaredConstructor().newInstance()); // ✅ Fix lỗi deprecated
        FlatLaf.updateUI();
    } catch (InstantiationException | IllegalAccessException | NoSuchMethodException | java.lang.reflect.InvocationTargetException ex) {
        LoggingFacade.INSTANCE.logSevere(null, ex); // Kiểm tra xem có phương thức mới thay thế không
    }
}
